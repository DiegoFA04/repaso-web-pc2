using BasePlatform.API.Insurance.Application.Internal.CommandServices;
using BasePlatform.API.Insurance.Application.Internal.QueryServices;
using BasePlatform.API.Insurance.Domain.Repositories;
using BasePlatform.API.Insurance.Domain.Services;
using BasePlatform.API.Insurance.Infrastructure.Persistence.EFC.Repositories;
...
builder.Services.AddScoped<IPolicyCommandService, PolicyCommandService>();
